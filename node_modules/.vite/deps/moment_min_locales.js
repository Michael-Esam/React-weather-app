...
import { require_moment } from "./moment-DlGoAPnB.js";

//#region node_modules/moment/min/locales.js
var require_locales = /* @__PURE__ */ __commonJS({ "node_modules/moment/min/locales.js": ((exports, module) => {
	(function(global, factory) {
		...
		function relativeTimeWithPlural(number, withoutSuffix, key) {
			...
			else return number + " " + plural(format$1[key], +number);
		}
		moment.defineLocale("be", {
			...
			ordinal: function(number, period) {
				switch (period) {
					...
					case "DDD":
					case "w":
					case "W": return (number % 10 === 2 || number % 10 === 3) && number % 100 !== 12 && number % 100 !== 13 ? number + "-і" : number + "-ы";
					case "D": return number + "-га";
		...
		function specialMutationForYears(number) {
			switch (lastNumber(number)) {
				...
				case 4:
				case 5:
				case 9: return number + " bloaz";
				default: return number + " vloaz";
			}
		}
		...
		function processRelativeTime(number, withoutSuffix, key, isFuture) {
			switch (key) {
				case "m": return withoutSuffix ? "jedna minuta" : isFuture ? "jednu minutu" : "jedne minute";
			}
		}
		function translate(number, withoutSuffix, key) {
			...
			switch (key) {
				...
				case "mm":
					...
					return result;
				case "h": return withoutSuffix ? "jedan sat" : "jedan sat";
				case "hh":
		...
		function translate$1(number, withoutSuffix, key, isFuture) {
			var result = number + " ";
			switch (key) {
				case "s": return withoutSuffix || isFuture ? "pár sekund" : "pár sekundami";
				case "ss": if (withoutSuffix || isFuture) return result + (plural$1(number) ? "sekundy" : "sekund");
				else return result + "sekundami";
				case "m": return withoutSuffix ? "minuta" : isFuture ? "minutu" : "minutou";
				case "mm": if (withoutSuffix || isFuture) return result + (plural$1(number) ? "minuty" : "minut");
				else return result + "minutami";
				case "h": return withoutSuffix ? "hodina" : isFuture ? "hodinu" : "hodinou";
				case "hh": if (withoutSuffix || isFuture) return result + (plural$1(number) ? "hodiny" : "hodin");
				else return result + "hodinami";
				case "d": return withoutSuffix || isFuture ? "den" : "dnem";
				case "dd": if (withoutSuffix || isFuture) return result + (plural$1(number) ? "dny" : "dní");
				else return result + "dny";
				case "M": return withoutSuffix || isFuture ? "měsíc" : "měsícem";
				case "MM": if (withoutSuffix || isFuture) return result + (plural$1(number) ? "měsíce" : "měsíců");
				else return result + "měsíci";
				case "y": return withoutSuffix || isFuture ? "rok" : "rokem";
				case "yy": if (withoutSuffix || isFuture) return result + (plural$1(number) ? "roky" : "let");
		...
		moment.defineLocale("cy", {
			...
			ordinal: function(number) {
				...
				if (b > 20) if (b === 40 || b === 50 || b === 60 || b === 80 || b === 100) output = "fed";
				else output = "ain";
		...
		function processRelativeTime$1(number, withoutSuffix, key, isFuture) {
			...
			return withoutSuffix ? format$1[key][0] : format$1[key][1];
		}
		...
		moment.defineLocale("el", {
			...
			months: function(momentToFormat, format$1) {
				if (!momentToFormat) return this._monthsNominativeEl;
				else if (typeof format$1 === "string" && /D/.test(format$1.substring(0, format$1.indexOf("MMMM")))) return this._monthsGenitiveEl[momentToFormat.month()];
		...
		moment.defineLocale("es-do", {
			...
			monthsShort: function(m, format$1) {
				if (!m) return monthsShortDot;
				else if (/-MMM-/.test(format$1)) return monthsShort$1[m.month()];
		...
		moment.defineLocale("es-mx", {
			...
			monthsShort: function(m, format$1) {
				...
				else if (/-MMM-/.test(format$1)) return monthsShort$2[m.month()];
		...
		moment.defineLocale("es-us", {
			...
			monthsShort: function(m, format$1) {
				...
				else if (/-MMM-/.test(format$1)) return monthsShort$3[m.month()];
		...
		moment.defineLocale("es", {
			...
			monthsShort: function(m, format$1) {
				...
				else if (/-MMM-/.test(format$1)) return monthsShort$4[m.month()];
		...
		function processRelativeTime$4(number, withoutSuffix, key, isFuture) {
			...
			if (withoutSuffix) return format$1[key][2] ? format$1[key][2] : format$1[key][1];
			return isFuture ? format$1[key][0] : format$1[key][1];
		}
		...
		moment.defineLocale("fr-ca", {
			...
			ordinal: function(number, period) {
				switch (period) {
					...
					case "D":
					case "DDD":
					case "d": return number + (number === 1 ? "er" : "e");
					case "w":
					case "W": return number + (number === 1 ? "re" : "e");
				}
			}
		});
		//! moment.js locale configuration
		...
		moment.defineLocale("fr", {
			...
			ordinal: function(number, period) {
				switch (period) {
					case "D": return number + (number === 1 ? "er" : "");
					default:
					case "M":
					case "Q":
					case "DDD":
		...
		moment.defineLocale("fy", {
			...
			monthsShort: function(m, format$1) {
				...
				else if (/-MMM-/.test(format$1)) return monthsShortWithoutDots[m.month()];
		...
		function translate$3(number, withoutSuffix, key) {
			...
			switch (key) {
				case "ss":
					...
					return result;
				case "m": return withoutSuffix ? "jedna minuta" : "jedne minute";
				case "mm":
					if (number === 1) result += "minuta";
					else if (number === 2 || number === 3 || number === 4) result += "minute";
					else result += "minuta";
					return result;
				case "h": return withoutSuffix ? "jedan sat" : "jednog sata";
				case "hh":
					if (number === 1) result += "sat";
					else if (number === 2 || number === 3 || number === 4) result += "sata";
					else result += "sati";
		...
		moment.defineLocale("hr", {
			...
			calendar: {
				...
				lastWeek: function() {
					switch (this.day()) {
						case 0: return "[prošlu] [nedjelju] [u] LT";
		...
		function translate$5(number, withoutSuffix, key, isFuture) {
			var result = number + " ";
			switch (key) {
				case "s": return withoutSuffix || isFuture ? "nokkrar sekúndur" : "nokkrum sekúndum";
				case "ss":
					if (plural$2(number)) return result + (withoutSuffix || isFuture ? "sekúndur" : "sekúndum");
					return result + "sekúnda";
				case "m": return withoutSuffix ? "mínúta" : "mínútu";
				case "mm":
				...
				case "y": return withoutSuffix || isFuture ? "ár" : "ári";
				case "yy":
		...
		moment.defineLocale("it", {
			...
			calendar: {
				...
				lastWeek: function() {
					switch (this.day()) {
						case 0: return "[La scorsa] dddd [a" + (this.hours() > 1 ? "lle " : this.hours() === 0 ? " " : "ll'") + "]LT";
						default: return "[Lo scorso] dddd [a" + (this.hours() > 1 ? "lle " : this.hours() === 0 ? " " : "ll'") + "]LT";
					}
				},
				sameElse: "L"
			},
		...
		moment.defineLocale("ja", {
			...
			ordinal: function(number, period) {
				switch (period) {
					case "y": return number === 1 ? "元年" : number + "年";
					case "d":
					case "D":
					case "DDD": return number + "日";
					default: return number;
				}
			},
			relativeTime: {
		...
		moment.defineLocale("ko", {
			...
			ordinal: function(number, period) {
				switch (period) {
					case "d":
					case "D":
					case "DDD": return number + "일";
					case "M": return number + "월";
					case "w":
					case "W": return number + "주";
					default: return number;
				}
			},
			meridiemParse: /오전|오후/,
		...
		moment.defineLocale("ku-kmr", {
			...
			meridiem: function(hours, minutes, isLower) {
				if (hours < 12) return isLower ? "bn" : "BN";
				else return isLower ? "pn" : "PN";
			},
		...
		*/
		function format(forms$1, number, withoutSuffix) {
			if (withoutSuffix) return number % 10 === 1 && number % 100 !== 11 ? forms$1[2] : forms$1[3];
			else return number % 10 === 1 && number % 100 !== 11 ? forms$1[0] : forms$1[1];
		}
		...
		function translate$7(number, withoutSuffix, key, isFuture) {
			switch (key) {
				case "s": return withoutSuffix ? "хэдхэн секунд" : "хэдхэн секундын";
				case "ss": return number + (withoutSuffix ? " секунд" : " секундын");
				case "m":
				case "mm": return number + (withoutSuffix ? " минут" : " минутын");
				case "h":
				case "hh": return number + (withoutSuffix ? " цаг" : " цагийн");
				case "d":
				case "dd": return number + (withoutSuffix ? " өдөр" : " өдрийн");
				case "M":
				case "MM": return number + (withoutSuffix ? " сар" : " сарын");
				case "y":
				case "yy": return number + (withoutSuffix ? " жил" : " жилийн");
				default: return number;
			}
		}
		...
		moment.defineLocale("nl-be", {
			...
			monthsShort: function(m, format$1) {
				...
				else if (/-MMM-/.test(format$1)) return monthsShortWithoutDots$1[m.month()];
		...
		moment.defineLocale("nl", {
			...
			monthsShort: function(m, format$1) {
				...
				else if (/-MMM-/.test(format$1)) return monthsShortWithoutDots$2[m.month()];
		...
		function translate$8(number, withoutSuffix, key) {
			var result = number + " ";
			switch (key) {
				case "ss": return result + (plural$3(number) ? "sekundy" : "sekund");
				case "m": return withoutSuffix ? "minuta" : "minutę";
				case "mm": return result + (plural$3(number) ? "minuty" : "minut");
				case "h": return withoutSuffix ? "godzina" : "godzinę";
				case "hh": return result + (plural$3(number) ? "godziny" : "godzin");
				case "ww": return result + (plural$3(number) ? "tygodnie" : "tygodni");
				case "MM": return result + (plural$3(number) ? "miesiące" : "miesięcy");
				case "yy": return result + (plural$3(number) ? "lata" : "lat");
			}
		}
		moment.defineLocale("pl", {
			months: function(momentToFormat, format$1) {
				if (!momentToFormat) return monthsNominative;
				else if (/D MMMM/.test(format$1)) return monthsSubjective[momentToFormat.month()];
		...
		function relativeTimeWithPlural$2(number, withoutSuffix, key) {
			...
			return number + separator + format$1[key];
		}
		...
		function relativeTimeWithPlural$3(number, withoutSuffix, key) {
			...
			else return number + " " + plural$4(format$1[key], +number);
		}
		var monthsParse$b = [
			/^янв/i,
			/^фев/i,
		...
		moment.defineLocale("ru", {
			...
			ordinal: function(number, period) {
				switch (period) {
					case "M":
					case "d":
					case "DDD": return number + "-й";
					case "D": return number + "-го";
					case "w":
					case "W": return number + "-я";
					default: return number;
				}
			},
			week: {
		...
		function translate$9(number, withoutSuffix, key, isFuture) {
			var result = number + " ";
			switch (key) {
				case "s": return withoutSuffix || isFuture ? "pár sekúnd" : "pár sekundami";
				case "ss": if (withoutSuffix || isFuture) return result + (plural$5(number) ? "sekundy" : "sekúnd");
				else return result + "sekundami";
				case "m": return withoutSuffix ? "minúta" : isFuture ? "minútu" : "minútou";
				case "mm": if (withoutSuffix || isFuture) return result + (plural$5(number) ? "minúty" : "minút");
				else return result + "minútami";
				case "h": return withoutSuffix ? "hodina" : isFuture ? "hodinu" : "hodinou";
				case "hh": if (withoutSuffix || isFuture) return result + (plural$5(number) ? "hodiny" : "hodín");
				else return result + "hodinami";
				case "d": return withoutSuffix || isFuture ? "deň" : "dňom";
				case "dd": if (withoutSuffix || isFuture) return result + (plural$5(number) ? "dni" : "dní");
				else return result + "dňami";
				case "M": return withoutSuffix || isFuture ? "mesiac" : "mesiacom";
				case "MM": if (withoutSuffix || isFuture) return result + (plural$5(number) ? "mesiace" : "mesiacov");
				else return result + "mesiacmi";
				case "y": return withoutSuffix || isFuture ? "rok" : "rokom";
				case "yy": if (withoutSuffix || isFuture) return result + (plural$5(number) ? "roky" : "rokov");
		...
		function processRelativeTime$9(number, withoutSuffix, key, isFuture) {
			var result = number + " ";
			switch (key) {
				case "s": return withoutSuffix || isFuture ? "nekaj sekund" : "nekaj sekundami";
				case "ss":
					...
					return result;
				case "m": return withoutSuffix ? "ena minuta" : "eno minuto";
				case "mm":
					...
					return result;
				case "h": return withoutSuffix ? "ena ura" : "eno uro";
				case "hh":
					...
					return result;
				case "d": return withoutSuffix || isFuture ? "en dan" : "enim dnem";
				case "dd":
					...
					return result;
				case "M": return withoutSuffix || isFuture ? "en mesec" : "enim mesecem";
				case "MM":
					...
					return result;
				case "y": return withoutSuffix || isFuture ? "eno leto" : "enim letom";
				case "yy":
		...
		function translate$a(number, withoutSuffix, string, isFuture) {
			...
			switch (string) {
				case "ss": return numberNoun + " lup";
				case "mm": return numberNoun + " tup";
				case "hh": return numberNoun + " rep";
				case "dd": return numberNoun + " jaj";
				case "MM": return numberNoun + " jar";
				case "yy": return numberNoun + " DIS";
			}
		}
		...
		function processRelativeTime$a(number, withoutSuffix, key, isFuture) {
			...
			return isFuture ? format$1[key][0] : withoutSuffix ? format$1[key][0] : format$1[key][1];
		}
		//! moment.js locale configuration
		...
		moment.defineLocale("ug-cn", {
			...
			ordinal: function(number, period) {
				switch (period) {
					case "d":
					case "D":
					case "DDD": return number + "-كۈنى";
					case "w":
					case "W": return number + "-ھەپتە";
					default: return number;
				}
			},
			preparse: function(string) {
		...
		function relativeTimeWithPlural$4(number, withoutSuffix, key) {
			...
			else return number + " " + plural$6(format$1[key], +number);
		}
		function weekdaysCaseReplace(m, format$1) {
			var weekdays$1 = {
				nominative: "неділя_понеділок_вівторок_середа_четвер_п’ятниця_субота".split("_"),
				accusative: "неділю_понеділок_вівторок_середу_четвер_п’ятницю_суботу".split("_"),
				genitive: "неділі_понеділка_вівторка_середи_четверга_п’ятниці_суботи".split("_")
			}, nounCase;
			if (m === true) return weekdays$1["nominative"].slice(1, 7).concat(weekdays$1["nominative"].slice(0, 1));
			if (!m) return weekdays$1["nominative"];
			nounCase = /(\[[ВвУу]\]) ?dddd/.test(format$1) ? "accusative" : /\[?(?:минулої|наступної)? ?\] ?dddd/.test(format$1) ? "genitive" : "nominative";
			return weekdays$1[nounCase][m.day()];
		}
			...
			calendar: {
				...
				lastWeek: function() {
					switch (this.day()) {
						...
						case 3:
						case 5:
						case 6: return processHoursFunction("[Минулої] dddd [").call(this);
						case 1:
						case 2:
						case 4: return processHoursFunction("[Минулого] dddd [").call(this);
					}
				},
				sameElse: "L"
			},
...
//#endregion
export default require_locales();

//# sourceMappingURL=moment_min_locales.js.map