import { __commonJS, __toESM } from "./chunk-B4p5S3KX.js";
...
var responsivePropType = import_prop_types$9.default.oneOfType([
...
(function(_jsx$10) {
	var JSX;
	(function(_JSX) {})(JSX || (JSX = _jsx$10.JSX || (_jsx$10.JSX = {})));
})(jsx || (jsx = {}));
...
function useTheme$2(defaultTheme$2 = null) {
...
//#endregion
export { CacheProvider, DefaultPropsProvider_default, InitColorSchemeScript, StyleSheet, ThemeProvider_default, _extends, alpha, capitalize, clsx_default, composeClasses, createBreakpoints, createCache, createColorScheme, createContainer, createCssVarsProvider, createMixins, createSpacing, createTheme, createThemeWithVars, createTransitions, createTypography, css, darken, decomposeColor, deepmerge, defaultSxConfig_default, defaultTheme_default, duration, easing, emphasize, excludeVariablesFromRoot_default, generateUtilityClass, getContrastRatio, getLuminance, getOverlayAlpha, hexToRgb, hslToRgb, identifier_default, isPlainObject, keyframes, lighten, recomposeColor, require_prop_types, resolveProps, rgbToHex, rootShouldForwardProp_default, shouldSkipGeneratingVar, styleFunctionSx_default, styled_default, unstable_memoTheme, useDefaultProps, useEnhancedEffect_default, useId, useThemeProps, useTheme_default };
//# sourceMappingURL=styled-CAStyx-G.js.map